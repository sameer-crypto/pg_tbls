...
| pk_seq_comn_updatecostdate | PRIMARY KEY | PRIMARY KEY (branchid, transactiondate, status) |
...
| pk_seq_comn_updatecostdate | CREATE UNIQUE INDEX pk_seq_comn_updatecostdate ON public.comn_updatecostdate USING btree (branchid, transactiondate, status) |
